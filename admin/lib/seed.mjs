...
const thread = await saveThread({ id: id('th'), title: 'Why contractors lose review requests', createdAt: now, updatedAt: now });
await addMessage({ id: id('msg'), threadId: thread.id, role: 'user', createdAt: now, content: [
...
await addMessage({ id: id('msg'), threadId: thread.id, role: 'assistant', createdAt: now, content: [
